...
const API_PATH = 'https://galacticdigitalstudios.com/backend/public/api/bluerose';
            ...
            <div className="container">
                <div className="row">
                    <div className="col">
                        ...
                        <div className="mb-3">
                            <label htmlFor="messageText" className="form-label">What Interests You the Most About Possibly Joining the Blue Rose Affiliation?</label>
